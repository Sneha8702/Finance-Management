  ...
  return (
    <div style={{ animation: "slideIn 0.6s cubic-bezier(0.16, 1, 0.3, 1)" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        <h3 style={{ fontSize: "28px", fontWeight: "800", color: "#fff", marginBottom: "4px" }}>
          Hello, {username || "User"}
        </h3>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
        ...
        <div className="glass-card" style={{ 
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "14px", fontWeight: "600", marginBottom: "8px", textTransform: "uppercase", letterSpacing: "1px" }}>
              Total Balance
            </p>
            <h2 style={{ fontSize: "42px", fontWeight: "800", color: "#fff", marginBottom: "24px" }}>
        ...
        <div style={{ 
          ...
          {/* Income Card */}
          <div className="glass-card" style={{ padding: "20px", maxWidth: "none" }}>
            ...
            <div style={{ fontSize: "20px", fontWeight: "700", color: "#fff" }}>{formatCurrency(income)}</div>
          </div>
          ...
          <div className="glass-card" style={{ padding: "20px", maxWidth: "none" }}>
            ...
            <div style={{ fontSize: "20px", fontWeight: "700", color: "#fff" }}>{formatCurrency(expense)}</div>
          </div>
          ...
          <div className="glass-card" style={{ padding: "20px", maxWidth: "none" }}>
            ...
            <div style={{ fontSize: "20px", fontWeight: "700", color: "#fff" }}>{formatCurrency(due)}</div>
          </div>

        </div>

        {/* 📉 Spending Analysis Section */}
        <div className="glass-card" style={{ padding: "24px", maxWidth: "none" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
            <h4 style={{ fontSize: "16px", fontWeight: "700", color: "#fff" }}>Monthly Budget Usage</h4>
